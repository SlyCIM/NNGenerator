...
class GeneratorForm(FlaskForm):
    ...
    g_min = StringField("Minimal radius of the object (mm)", validators=[DataRequired()], default='2')
    g_max = StringField("Maximal radius of the object (mm)", validators=[DataRequired()], default='200')
    fi_min = StringField("Minimal azimuth of the object (rad, > 0)", validators=[DataRequired()], default='0')
    fi_max = StringField("Maximal azimuth of the object (rad, < 3.14)", validators=[DataRequired()], default=f'{math.pi}')
    r_min = StringField("Minimal distance between the center of the coordinate system and the center of the object (mm)",
                    validators=[DataRequired()], default='40')
